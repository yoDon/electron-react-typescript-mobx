...
The above commands will build the source code under ```/src``` into a pair of html files (one for the electron app, the other for the website) and a pair of bundled JS files (same purposes) that end up under ```/dist``` 
